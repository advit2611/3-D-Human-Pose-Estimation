...
data = sio.loadmat('D:/Documents/RIT Course Work/Spring 2023/Neural Computing/Project/dataset used/S1/Seq1/annot.mat')
...
#         yield poses
dataset = Dataset3dhp('train',  200, 200, actions='all')
data = dataset.sample()
...
render_animation(dataset.skeleton, pose_gen, 'test', 200, fix_0=True, output=None, size=8, ncol=2, interval=50)
